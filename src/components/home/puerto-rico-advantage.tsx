    ...
    <section className="bg-background">
      <div className="container grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-12 md:py-24">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg text-foreground/80">
            As one of the island’s highest-elevation farms, we enjoy air temperatures some 10°F – 25°F cooler than most others, allowing us to grow produce locally that is typically imported at outrageous costs. This unique position allows us to directly address food security and affordability for Puerto Rico.
          </p>
        </div>
      </div>
    </section>
